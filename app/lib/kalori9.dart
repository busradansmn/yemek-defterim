...
class kalori9 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori9> {
  String recipeDocumentId = 'kumpir'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
