...
class kalori6 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori6> {
  String recipeDocumentId = 'pizza'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
