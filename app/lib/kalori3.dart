...
class kalori3 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori3> {
  String recipeDocumentId = 'karnıyarık'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
