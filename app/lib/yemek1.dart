...
class yemek1 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<yemek1> {
  String recipeDocumentId = 'manti'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
  int favValue = 0;
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          favValue = recipeData['fav'] ?? 0; // Firebase'den gelen fav değeri
