...
class kalori7 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori7> {
  String recipeDocumentId = 'şehriye salatası'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
