...
class kalori4 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori4> {
  String recipeDocumentId = 'kayseri yaglaması'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
