...
class kalori2 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori2> {
  String recipeDocumentId = 'yaprak sarması'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
