...
class kalori5 extends StatefulWidget {
  @override
  _Yemek1State createState() => _Yemek1State();
}

class _Yemek1State extends State<kalori5> {
  String recipeDocumentId = 'lazanya'; // Firestore doküman ID'sini kendi tarifinizle değiştirin.
